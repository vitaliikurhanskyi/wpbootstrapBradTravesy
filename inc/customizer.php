<?php
    function wpb_customize_register($wp_customize){
        ...
        $wp_customize->add_setting('showcase_text', array(
            'default' => _x('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis sit modi sapiente necessitatibus a nobis magnam similique architecto, accusamus autem.', 'wpbootstrap'),
            'type' => 'theme_mod'
        ));
